...
class TicketController {
    ...
    public function create() {
        ...
        // Calculate maxQty based on the remaining capacity of the selected event
        $maxQty = 10;
        if ($event_id) {
